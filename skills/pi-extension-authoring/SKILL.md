...
Use the generated `.preloadignore` file as the baseline. It keeps runtime TypeScript and package metadata in preload context and excludes other project files.
